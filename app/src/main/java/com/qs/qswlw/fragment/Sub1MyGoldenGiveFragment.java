...
public class Sub1MyGoldenGiveFragment extends BaseDataBindingFragment implements IMyGoldenView {
...
//        bind.rvFgMygold.addView(unionHeadview);
    ...
    protected void initData() {
        ...
        myGoldenPersenter.getData(MyApplication.TOKEN,page,"model1","give","");

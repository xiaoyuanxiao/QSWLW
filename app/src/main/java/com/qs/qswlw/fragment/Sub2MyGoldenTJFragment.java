...
public class Sub2MyGoldenTJFragment extends BaseDataBindingFragment implements IMyGoldenView {
    ...
    protected void initData() {
        ...
        myGoldenPersenter.getData(MyApplication.TOKEN,page,"model2","tjjd","");

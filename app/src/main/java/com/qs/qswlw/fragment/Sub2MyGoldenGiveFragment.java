...
public class Sub2MyGoldenGiveFragment extends BaseDataBindingFragment implements IMyGoldenView {
    ...
    protected void initData() {
        ...
        myGoldenPersenter.getData(MyApplication.TOKEN,page,"model2","give","");

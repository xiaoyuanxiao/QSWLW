...
public class MerchantSalesReviewOneFragment extends BaseFragment {

    private SwipeRefreshView swipeRefreshView;
    private ListView lv_sw;

    public static MerchantSalesReviewOneFragment newInstance() {
        return  new MerchantSalesReviewOneFragment();
    }
    @Override
    View initView() {

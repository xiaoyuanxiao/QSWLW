...
public class BusinessSettingAdapter extends BaseAdapter {
    public String[] contents={"商家录单","我要推荐","客户消费记录","我的机构","商城订单","现金专区","消费金豆专区","收货地址","消费银豆","创业种子",
    "我的金豆","我的奖金","我要提现","促销抽奖记录","我的角色","平台自营","平台特供","平台现付","商家完善资料","我要充值","商品管理","我的商城","商家营业额"};
...
//            R.mipmap.wdjb,R.mipmap.cyzj,R.mipmap.wslhy,R.mipmap.user_ren, R.mipmap.cyzj,R.mipmap.tubiao0028,R.mipmap.cj,R.mipmap.huishou};
    public int[] ids = {R.mipmap.user_09,R.mipmap.wytj,R.mipmap.jilu,R.mipmap.tubiao0030,R.mipmap.daizi,R.mipmap.jinbi,R.mipmap.jinbi2,
            R.mipmap.user_address,R.mipmap.xfyd,R.mipmap.cyzz,R.mipmap.xfjd,R.mipmap.xfjd,R.mipmap.tx,R.mipmap.cj,R.mipmap.user_ren,R.mipmap.is_me,
        R.mipmap.is_me,R.mipmap.is_me, R.mipmap.bianji,R.mipmap.edu,R.mipmap.spgl,R.mipmap.lingdang,R.mipmap.yye};

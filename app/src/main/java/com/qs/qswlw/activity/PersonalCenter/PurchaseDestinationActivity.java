...
public class PurchaseDestinationActivity extends BaseInfoActivity {
    ...
    public void initfindviewByid() {
        ...
        tv_titlebar_center.setText("购买去向");
        tv_venturegold_left.setText("购买金额");
        tv_venturegold_center.setText("购买类型");
        tv_venturegold_right.setText("购买时间");
    }

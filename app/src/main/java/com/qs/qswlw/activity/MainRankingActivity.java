...
import com.qs.qswlw.Mode.MainRankingMode;
...
public class MainRankingActivity extends BaseInfoActivity implements IRankingView {
    ...
    private List<MainRankingMode> viewpagedata;
    ...
    public View setConetnView() {
        ...
        viewpagedata.add(new MainRankingMode(this, 100));
        viewpagedata.add(new MainRankingMode(this, 200));
        viewpagedata.add(new MainRankingMode(this, 300));

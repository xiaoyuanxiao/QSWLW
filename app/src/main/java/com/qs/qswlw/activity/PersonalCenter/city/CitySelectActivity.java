...
import com.qs.qswlw.view.cityselect.CityUtils;
import com.qs.qswlw.view.cityselect.MyRegion;

import java.util.ArrayList;

import static com.qs.qswlw.R.id.tv_titlebar_right;
...
public class CitySelectActivity extends Activity implements OnClickListener {
	...
	private void viewInit() {
		...
		tv_titlebar_center = (TextView) findViewById(tv_titlebar_right);
		tv_titlebar_center.setText("确认");
	...
	Handler hand = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 3:
				System.out.println("区县列表what======" + msg.what);
				regions = (ArrayList<MyRegion>) msg.obj;
				adapter.clear();
				adapter.addAll(regions);
				adapter.update();
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.iv_titlebar://返回按钮监听
			finish();
			break;
		case R.id.tv_titlebar_right://确定按钮监听

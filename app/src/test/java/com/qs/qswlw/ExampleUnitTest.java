...
public class ExampleUnitTest {
    ...
    public void addition_isCorrect() throws Exception {
        ...
        ReHttpUtils.instans().httpRequestMain/**这是单线程  因为测试多线程 不好看结果*/(new HttpSubCribe<MainBean<RankingBean>>() {
            ...
            @Override
            public void onNext(MainBean<RankingBean> s) {
            ...
            public Observable<MainBean<RankingBean>> getObservable(MyRetroService retrofit) {
                 ...
                 * 跟你正常使用是一模一样的 使用
                 */
               return retrofit.getRankingData("yue");

...
public class Test {
    ...
    public void addition_isCorrect() throws Exception {
        ...
        ReHttpUtils.instans().httpRequestMain/**这是单线程  因为测试多线程 不好看结果*/(new HttpSubCribe<MainBean<MyProfitBean>>() {
            ...
            @Override
            public void onNext(MainBean<MyProfitBean> s) {
            ...
            public Observable<MainBean<MyProfitBean>> getObservable(MyRetroService retrofit) {
                 ...
                 *
                 */
                return retrofit.getMyProfitData("39edbdf5f6363b870ea9c6b555dc4132", 1);//参数 不是乱写的。。。。你说乱写的  只要格式对上 。。。我什么时候说过呵呵
            }
        });
